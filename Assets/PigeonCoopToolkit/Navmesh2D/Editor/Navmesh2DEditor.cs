    ...
    public class Navmesh2DEditor : VersionedEditorWindow
    {
        ...
        private List<IntPoint> PolygonFromCollider2D(Collider2D c, bool addPadding)
        {
            ...
            if (c is CircleCollider2D)
            {
                ...
                {
                    polygon.Add((Vector2)(Quaternion.Euler(0, 0, angleStep * i) * Vector2.up * radius) + circleCollider.center);
                }
            ...
            else if (c is BoxCollider2D)
            {
                ...
                polygon.Add(new Vector2(-boxCollider.size.x / 2, -boxCollider.size.y / 2) + boxCollider.center);
                polygon.Add(new Vector2(boxCollider.size.x / 2, -boxCollider.size.y / 2) + boxCollider.center);
                polygon.Add(new Vector2(boxCollider.size.x / 2, boxCollider.size.y / 2) + boxCollider.center);
                polygon.Add(new Vector2(-boxCollider.size.x / 2, boxCollider.size.y / 2) + boxCollider.center);
            }
